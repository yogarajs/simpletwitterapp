...
(
    ...
    [device_type_name] NVARCHAR(10) NOT NULL
)
GO
...
SET IDENTITY_INSERT [dbo].[user_device] ON
INSERT INTO [dbo].[user_device] ([user_device_id], [user_id], [device_type_id], [device_name]) VALUES (1, 2, 1, N'Test device')
INSERT INTO [dbo].[user_device] ([user_device_id], [user_id], [device_type_id], [device_name]) VALUES (2, 3, 1, N'Test device')
SET IDENTITY_INSERT [dbo].[user_device] OFF
